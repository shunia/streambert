...
![TMDB signup page](screenshots/signup_tmdb.png)
...
![API settings page showing the request link](screenshots/api-settings_tmdb.png)

Select **"Personal use only"** and confirm.

![Personal use selection](screenshots/personal-use_tmdb.png)
...
![Application form](screenshots/application_tmdb.png)
...
![API settings page showing the Read Access Token](screenshots/token_tmdb.png)
